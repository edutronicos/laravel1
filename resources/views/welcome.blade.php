        ...
        <div class="row">
            <div class="col-12 shadow-lg m-3 p-3">
                <div class="row">
                    ...
                    <div class="col">
                        <a href="http://www.simepar.br/prognozweb/simepar/forecast_by_counties/4106902"><img src="imagens/home/clima.png" alt="" class="img-thumbnail img-fluid"></a>
                    </div>
                    <div class="col d-flex align-items-center text-nowrap">
                    ...
                    <div class="col">
                        <a href="https://www.google.com.br"><img src="imagens/home/google.png" alt="" class="img-thumbnail img-fluid"></a>
                    </div>
                    <div class="col d-flex align-items-center text-nowrap">
